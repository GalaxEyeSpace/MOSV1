# Generated by Django 5.1.6 on 2025-02-20 11:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestep', models.DateTimeField(blank=True, null=True)),
                ('net_power', models.TextField(blank=True, null=True)),
                ('solar', models.TextField(blank=True, null=True)),
                ('storage', models.TextField(blank=True, null=True)),
                ('threshold', models.TextField(blank=True, null=True)),
                ('power_consumed', models.TextField(blank=True, null=True)),
            ],
            options={
                'db_table': 'power',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestep', models.DateTimeField(blank=True, null=True)),
                ('instant_data_gen', models.TextField(blank=True, null=True)),
                ('instant_data_down', models.TextField(blank=True, null=True)),
                ('ssd_storage', models.TextField(blank=True, null=True)),
